...
const PrivacyPolicyPage: React.FC<PageProps>  = () => (
  <main id="privacy-page">
    ...
    <p>Effective date: 2023-02-06</p>
    <p>1. <b>Introduction</b></p>
    <p>Welcome to <b> Stackless LLC</b>.</p>
    <p><b>Stackless LLC</b> (“us”, “we”, or “our”) operates <b>https://stackless.tech/</b> (hereinafter referred to as <b>“Service”</b>).</p>
    <p>Our Privacy Policy governs your visit to <b>https://stackless.tech/</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
    ...
    <p><b>SERVICE</b> means the https://stackless.tech/ website operated by Stackless LLC.</p>
    ...
    <p>Stackless LLC uses the collected data for various purposes:</p>
    ...
    <p>Stackless LLC will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    ...
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>info@stackless.tech</b>.</p>
    ...
    <p>0.4. users are able to change their personal information by emailing us at <b>info@stackless.tech</b>.</p>
    ...
    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>info@stackless.tech</b>.</p>
    ...
    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>info@stackless.tech</b>.</p>
  </main>
);
